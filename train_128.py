...
def main():
    ...
    print('# do we have a valid capture at all? : {}',cap.isOpened() )
    print('# did we get an image? {}',ret)
    print('')
    ...
    if args.gpu >= 0:
        ...
        cnn.to_cpu()  # Copy the model to the GPU
        dis.to_cpu()  # Copy the model to the GPU
        l.to_cpu()
